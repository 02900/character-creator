...
export function LineArtForm({ config, updateConfig }: LineArtFormProps) {
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium">Line Art Settings</h3>
        <p className="text-sm text-muted-foreground">
          Configure the line art style for your character
        </p>
      </div>
      
      <div className="space-y-4">
        <div>
          <h4 className="text-md font-medium mb-2">Line Weight</h4>
          <RadioGroup
        ...
        <div className="flex items-center justify-between rounded-lg border p-4">
          <div className="space-y-0.5">
            <Label htmlFor="cleanLines">Clean Lines</Label>
            <div className="text-xs text-muted-foreground">
              Ensure lines are clean and well-defined
            </div>
          </div>
          <Switch
            id="cleanLines"
        ...
        <div className="flex items-center justify-between rounded-lg border p-4 bg-muted/50">
          <div className="space-y-0.5">
            <Label htmlFor="shading" className="text-muted-foreground">Shading</Label>
            <div className="text-xs text-muted-foreground">
              Not allowed for coloring books (always disabled)
            </div>
          </div>
          <Switch
            id="shading"
        ...
        <div className="flex items-center justify-between rounded-lg border p-4 bg-muted/50">
          <div className="space-y-0.5">
            <Label htmlFor="grayscale" className="text-muted-foreground">Grayscale</Label>
            <div className="text-xs text-muted-foreground">
              Not allowed for coloring books (always disabled)
            </div>
          </div>
